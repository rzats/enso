...
import org.enso.languageserver.websocket.mock.MockIdGenerator
...
abstract class WebSocketServerTest
  ...
  val idGenerator = new MockIdGenerator
  ...
  override def beforeEach(): Unit = {
    ...
    val languageServer =
      system.actorOf(
        Props(new LanguageServer(config, new FileSystem[IO]) (idGenerator))
      )
