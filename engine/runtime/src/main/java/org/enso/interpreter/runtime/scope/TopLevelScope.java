...
public class TopLevelScope {
  ...
  public static class PolyglotView {
    ...
    public Module get_module(String moduleName) throws UnknownIdentifierException {
    ...
    public Module create_module(String moduleName) {
      return new Module(
          QualifiedName.simpleName(moduleName), scope.context.createScope(moduleName));
    }

    public Module register_module(String qualifiedName, String path) {
  ...
  //    }
  //
  //    private static Module registerModule(TopLevelScope scope, Object[] arguments, Context
  // context)
  //        throws ArityException, UnsupportedTypeException {
  ...
  //    }
  //
  //    private static Object unregisterModule(TopLevelScope scope, Object[] arguments, Context
  // context)
  //        throws ArityException, UnsupportedTypeException {
