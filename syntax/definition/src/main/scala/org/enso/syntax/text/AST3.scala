package org.enso.syntax.text.test3
...
//  }
//
//  type AST     = _Shape[Def] // _AST[_Shape]
//  type _Def[T] = _Shape[T]
//  type Def     = Fix[_Def]
//  //  type _AST[+F[_]] = F[Def]
//
//  //// Aliases ////
...
//  //    */
//  sealed trait _Shape[T] extends Symbol
//
//  class ReprCache[Self[_]](implicit ev: Repr.Of[Self[_]]) {
//    val repr = Repr.Of[Self[_]].of(this.asInstanceOf[Self[_]])
//  }
//  //
...
//  //  //////////////////////////////////////////////////////////////////////////////
//  //
//  type Literal = _Literal[Def]
//  type Ident   = _Ident[Def]
...
//  final case class _Var[T](name: String, id: ID)
//      extends ReprCache[_Var]
//      with _Ident[T]
